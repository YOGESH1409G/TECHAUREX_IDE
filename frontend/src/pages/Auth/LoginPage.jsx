...
import { loginUser, startGoogleOAuth, startGitHubOAuth } from '../../services/authService';
    ...
    <div className="space-auth-container">
      ...
      <div className="branding-panel">
        <div className="branding-header">
          ...
          <div>
            <h1 className="brand-name">TECHAUREX</h1>
          </div>
        </div>

        <div className="branding-tagline">
          <p>Code.Collaborate.Create </p>
          <p className="adventure-text"> in real time!</p>
        </div>
      ...
      <div className="signin-panel">
        ...
        <p className="signin-subtitle">Sign in with email address</p>
        ...
        <form onSubmit={handleSubmit} className="signin-form">
          ...
          <button type="submit" className="btn-gradient-signup" disabled={isLoading}>
